...
export default function EnvironmentPage() {
  ...
  const fetchEnvironment = async (id: string) => {
    try {
      const docRef = await db.collection("environments").doc(id).get()
      
      if (docRef.exists) {
        const data = docRef.data() as Omit<Environment, "id">
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`AI environment: ${environment.task}`} />
      </Head>
